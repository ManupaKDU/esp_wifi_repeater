...
<td><input id='lock_device' type='checkbox' name='lock' value='l' onchange=\"document.getElementById('lock_submit').disabled = !this.checked;\" aria-describedby='lock_help'></td>\
</tr>\
<tr>\
<td></td>\
...
<small id='lock_help'>\
<i>Info:</i> Locking requires STA password to unlock<br />\
</small>\
</form>\
\
