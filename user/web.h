...
<td>\
 <select id='repeater_ap_open' name='ap_open' onchange=\"var isOpen = (this.value === 'open'); document.getElementById('repeater_ap_password').disabled = isOpen;\">\
 <option value='open'%s>Open</option>\
 <option value='wpa2'%s>WPA2</option>\
</select>\
</td>\
...
<script>var isOpen = (document.getElementById('repeater_ap_open').value === 'open'); document.getElementById('repeater_ap_password').disabled = isOpen;</script>\
</form>\
\
<h2>Lock Config</h2>\
<form action='' method='GET'>\
