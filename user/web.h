...
<h2>STA Settings</h2>\
<form action='' method='GET' onsubmit=\"var b=this.querySelector('input[type=submit]');if(b){b.value='Processing...';setTimeout(function(){b.disabled=true;},10);}\">\
...
<td><input id='sta_password' type='password' name='password' value='%s' maxlength='63' placeholder='WiFi Password' autocorrect='off' autocapitalize='none' spellcheck='false'/> <label><input type='checkbox' aria-controls='sta_password' aria-label='Show STA password' title='Toggle password visibility' onclick=\"document.getElementById('sta_password').type = this.checked ? 'text' : 'password'\"> Show</label></td>\
</tr>\
<tr>\
...
<td>\
 <select id='ap_open' name='ap_open' aria-describedby='ap_sec_help' onchange=\"var isOpen = (this.value === 'open'); document.getElementById('ap_password').disabled = isOpen; document.getElementById('ap_show').disabled = isOpen; var req = document.getElementById('ap_pwd_req'); if(req) req.style.display = isOpen ? 'none' : 'inline';\">\
...
<td><input id='repeater_sta_password' type='password' name='password' value='%s' maxlength='63' placeholder='WiFi Password' autocorrect='off' autocapitalize='none' spellcheck='false'/> <label><input type='checkbox' aria-controls='repeater_sta_password' aria-label='Show STA password' title='Toggle password visibility' onclick=\"document.getElementById('repeater_sta_password').type = this.checked ? 'text' : 'password'\"> Show</label></td>\
</tr>\
<tr>\
<td></td>\
<td><input type='submit' value='Connect'/></td>\
...
<td>\
 <select id='repeater_ap_open' name='ap_open' aria-describedby='repeater_ap_sec_help' onchange=\"var isOpen = (this.value === 'open'); document.getElementById('repeater_ap_password').disabled = isOpen; document.getElementById('repeater_ap_show').disabled = isOpen; var req = document.getElementById('repeater_ap_pwd_req'); if(req) req.style.display = isOpen ? 'none' : 'inline';\">\
 <option value='open'%s>Open</option>\
 <option value='wpa2'%s>WPA2</option>\
</select>\
</td>\
