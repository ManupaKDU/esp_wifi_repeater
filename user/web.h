...
<td><input id='ap_network' type='text' name='network' value='%d.%d.%d.%d' required placeholder='e.g. 192.168.4.1' pattern='^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$' title='Valid IPv4 address' inputmode='decimal' autocorrect='off' autocapitalize='none' spellcheck='false'/></td>\
</tr>\
<tr>\
<td></td>\
