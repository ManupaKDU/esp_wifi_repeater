...
<td><input id='repeater_sta_password' type='password' name='password' value='%s'/></td>\
</tr>\
<tr>\
<td></td>\
<td><input type='submit' value='Connect'/></td>\
...
<td><input id='repeater_ap_password' type='text' name='ap_password' value='%s'/></td>\
</tr>\
<tr>\
<td><label for='repeater_ap_open'>Security:</label></td>\
<td>\
 <select id='repeater_ap_open' name='ap_open' onchange=\"document.getElementById('repeater_ap_password').disabled = (this.value === 'open');\">\
 <option value='open'%s>Open</option>\
 <option value='wpa2'%s>WPA2</option>\
</select>\
</td>\
...
<script>document.getElementById('repeater_ap_password').disabled = (document.getElementById('repeater_ap_open').value === 'open');</script>\
</form>\
\
<h2>Lock Config</h2>\
<form action='' method='GET'>\
