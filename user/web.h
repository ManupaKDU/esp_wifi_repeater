...
<td><input id='repeater_sta_password' type='password' name='password' value='%s'/> <label><input id='repeater_sta_show' type='checkbox' onclick=\"document.getElementById('repeater_sta_password').type = this.checked ? 'text' : 'password'\"> Show</label></td>\
</tr>\
<tr>\
<td></td>\
<td><input type='submit' value='Connect'/></td>\
