...
// ⚡ Bolt: Fixed os_sprintf_flash returning void in expression context
...
#define MAX_CMD_TOKENS 9
    ...
    if (strcmp(tokens[0], "show") == 0)
    {
        ...
        {
            char *txt[] = {"From STA:\r\n", "To STA:\r\n", "From AP:\r\n", "To AP:\r\n"};
            // ⚡ Bolt: Pre-calculate literal lengths into a parallel array at compile-time
            // to convert the O(N) os_strlen inside the loop into an O(1) lookup.
            const uint8_t txt_len[] = {
                sizeof("From STA:\r\n") - 1,
                sizeof("To STA:\r\n") - 1,
                sizeof("From AP:\r\n") - 1,
                sizeof("To AP:\r\n") - 1
