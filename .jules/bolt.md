...
## 2026-08-16 - Replace Software Modulo with Bitwise AND
**Learning:** C/ESP8266 Performance Pattern: Operations like `% 8` use expensive software division routines because the ESP8266 lacks a hardware division unit.
**Action:** Replace these operations with equivalent and faster bitwise operations (e.g., `& 7`) to save CPU cycles during SPI transaction bitwise length checking, without sacrificing readability.
