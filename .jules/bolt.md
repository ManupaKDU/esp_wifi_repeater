...
**Learning:** In , caching the string length with  avoids redundant inner-loop string traversal checks (). While it adds an initial O(N) pass, the overall parsing simplifies, measurably improving speed for longer strings.
