...
## 2026-03-14 - Pre-calculate string literal lengths in arrays
...
**Action:** Use parallel arrays containing `sizeof("literal") - 1` instead of calling `os_strlen(literal_array[i])` in loops to eliminate runtime evaluation overhead.
